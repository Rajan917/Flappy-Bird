...
#include <iostream> //created by @RajanShukla
#include <cstdlib>
#include <windows.h>
#include <conio.h>
#include <ctime>
...
void credits()
{
    ...
    {
    cout<<""<<endl<<endl;
    cout<<"               Lead programmer: @rajanshukla"<<endl<<endl;
    cout<<"               Designer: rajnsukla "<<endl<<endl;
    cout<<"               Testers: rajanshukla "<<endl<<endl;
    cout<<"               Special thanks to: Mukul Kirti Verma"<<endl<<endl;
